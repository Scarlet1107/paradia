...
export default function Home() {
  return (
    <>
      <AuthHeader />
      <main className="flex min-h-screen w-full flex-col items-center px-4 pb-16 sm:px-6 lg:px-8">
        {/* Header */}
        {/* Hero Section */}
        <motion.section
        ...
        >
          ...
          />
          <h1 className="mb-4 text-2xl font-bold text-gray-800 md:text-3xl xl:text-4xl">
